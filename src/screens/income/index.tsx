...
interface SpendingPageProps extends RouteComponentProps {
     

}

interface SpendingPageState {
    record_list: Record[];  // У КОТОРОГО TYPE = SPEND

}

class SpendingPage extends React.Component<SpendingPageProps, SpendingPageState> {


    constructor(props: Readonly<SpendingPageProps>) {
        super(props);
        this.state = {
            record_list: []};
    }
    ...
    async componentDidMount() {
        let record_list: Record[] = await dataService.getRecords('income');
...
export default withRouter(SpendingPage);